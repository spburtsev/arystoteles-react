...
const localization = new LocalizedStrings({
  [AppLocale.English]: {
    ...
    childDetails: {
      ...
      checkIfNewScreeningAvailable: 'Check if new screening is available',
      noScreeningsAvailable: 'No screenings available',
      edit: 'Edit',
    },
    children: {
      explore: 'Details',
  ...
  [AppLocale.Ukrainian]: {
    ...
    childDetails: {
      ...
      month: 'Місяць',
      months: 'Місяці',
      MeetsExpectations: 'Задовільняє очікуванням',
      NoResults: 'Немає результатів',
      checkIfNewScreeningAvailable: 'Перевірте, чи новий скринінг доступний',
      noScreeningsAvailable: 'Немає скринінгів',
      edit: 'Редагувати',
    },
    children: {
      explore: 'Детальніше',
